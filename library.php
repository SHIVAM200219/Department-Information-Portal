...
<body class="bg-info">
  ...
  <div class="container d-flex flex-column my-5 py-5 bg-secondary text-light">
    <div class="d-flex justify-content-around">
      <div class="bg-dark m-3 p-3" style="border-radius:50px">
      ...
      if ($_POST['submit'] == "Submit") {
        ...
        try {
          ...
          if (isset($_POST['bkname'])) {
            $b = $conn->query("SELECT* FROM id20433779_portaldb.books");
            $r = $conn->query("SELECT* FROM id20433779_portaldb.reserves");
            $s = $conn->query("SELECT* FROM id20433779_portaldb.students");
            $flag1 = 0;
            $b_id;
            $s_id;
